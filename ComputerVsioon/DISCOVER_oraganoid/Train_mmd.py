...
plt.savefig('/user/sina.garazhian/u12203/lustere-grete-mine/DISCOWER/models/mmd_version_train_2.png')
plt.close()
...
torch.save(encod, "/user/sina.garazhian/u12203/lustere-grete-mine/DISCOWER/models/encod_mmd_version_train_2.pt")
torch.save(decod, '/user/sina.garazhian/u12203/lustere-grete-mine/DISCOWER/models/decod_mmd_version_train_2.pt')
torch.save(subset_model, '/user/sina.garazhian/u12203/lustere-grete-mine/DISCOWER/models/subset_mmd_version_train_2.pt')
